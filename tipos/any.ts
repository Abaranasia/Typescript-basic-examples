...
let avenger: any = 123; // Acepta cualquier tipo de dato, es como no definir el tipo
...
console.log((avenger as string).charAt(0)); // Casteando a tipo string sí obtenemos la ayuda

avenger = 150.12; // Acepta number ahora
console.log(avenger.toFixed(2)); // No obtengo la ayuda
console.log((<number>avenger).toFixed(2)); // Casteando a tipo number sí obtenemos la ayuda
